import { InputFieldSvg, ReloadIcon, RoleIcon } from "assets/svg/icons";
import styles from "./MenteeGoalStep3.module.scss";
export default function MenteeGoalStep3() {
  return (
    <div className={styles.body}>
      <h2>Dig deeper into your goals with a mentor</h2>
      <p>
      ...
      <div className={styles.InputWrapper}>
        <div className={styles.inputItems}>
          <input
            type={"text"}
            placeholder={"What’s your top goal right now?"}
          />
        ...
        <div className={styles.inputItems}>
          <input
            type={"text"}
            placeholder={"Who is a relevant mentor for you?"}
          />
          <div className={styles.inputIcon}>
            <InputFieldSvg />
          </div>
        ...
        <div className={styles.inputItems}>
          <input type={"text"} placeholder={"Message for your mentors"} />
          <div className={styles.inputIcon}>
            <InputFieldSvg />
          </div>
        </div>
      ...
      <div className={styles.MentorsDetailsWrapper}>
        <div className={styles.MentorsItemleft}>
          <img
            ...
            alt=""
          />
          <div className={styles.mentorsImageItems}>
            <h5>
              Shina Rambo <span>NG</span>
            </h5>
            <h6>Bictory.io</h6>
        ...
        <div className={styles.MentorsItemright}>
          <p>Available on:</p>
          <span>May 10 11:00AM WAT</span>

          <button>Confirm Session Time</button>
        </div>
      </div>
    </div>
  );
